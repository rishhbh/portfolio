...
export const projects: Project[] = [
  {
    ...
    keyFeatures: [
      ...
      'Real-Time Token Streaming: SSE token streaming (text/event-stream) across Gemini 2.5 Flash, GPT OSS 120B, Gemma 4, and Sarvam 30B.',
      'Multilingual & Hinglish: Natural code-switched summarization and conversational workflows powered by Sarvam 30B.',
      'Hardened Security & Rate Limiting: Express.js v5 protected by JWT httpOnly cookies, Zod payload validation, bcrypt, and Upstash Redis sliding window rate limiting (@upstash/ratelimit).',
